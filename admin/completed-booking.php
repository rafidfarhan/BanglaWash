...
<html>
<head>
<title>BanglaWash | Completed Bookings</title>
...
if($ptype==1): echo "BASIC CLEANING (৳1,099)";endif;
if($ptype==2): echo "PREMIUM CLEANING (৳3,099)";endif;
if($ptype==3): echo "PLATINUM CLEANING (৳5,099)";endif;
