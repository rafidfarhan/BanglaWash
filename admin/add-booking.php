...
<html>
<head>
<title>BanglaWash | Add Car Washing Booking</title>
  	         ...
  	         <div class="tab-content">
                ...
                <?php $sql = "SELECT * from packages";
                                ...
                                foreach($plans as $plan)
                                    {               ?>  
                                        <option value="<?php echo htmlentities($plan->id);?>"><?php echo htmlentities($plan->name);?> (৳<?php echo htmlentities($plan->price);?>)</option>
                            <?php } ?>
              </select>
									</div>
								</div>
